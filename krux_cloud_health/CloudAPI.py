...
class CloudAPI(Application):

    def __init__(self, name=NAME):
        # Call to the superclass to bootstrap.
        super(CloudAPI, self).__init__(name=name)
    ...
    def add_cli_arguments(self, parser):
        ...
        super(CloudAPI, self).add_cli_arguments(parser)
    ...
    def run(self):
        call = self.get_report("cost/history", self.api_key)
